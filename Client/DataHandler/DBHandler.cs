...
namespace DataHandler
{
    ...
    { 
        ...
        public static String fillWithDump()
        {
            ...
            dump.Add("INSERT INTO UserProperties(email , name , password , securityCode , userId , imageId) VALUES('eranno@post.jce.ac.il', 'localhost' , '1234' , '187365543208213678653094' , '1' , '12')");
