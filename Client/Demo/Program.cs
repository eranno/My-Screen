...
namespace Demo
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Fiddler.FiddlerApplication.BeforeResponse += delegate(Session oSession) 
            //{
            //    if (oSession.fullUrl.EndsWith(".gif") || oSession.fullUrl.EndsWith(".png") || oSession.fullUrl.EndsWith(".jpg"))
            //    {
            //        arrs[i++] = oSession.fullUrl;
            //        Console.WriteLine("Noam :");
            //        Console.WriteLine(oSession.GetResponseBodyAsString());
            //        Console.WriteLine();
            //        //oSession.bBufferResponse = true;
            //        Console.WriteLine("is replaced: " +oSession.utilReplaceInResponse(oSession.fullUrl,"http://timg.co.il/f/Emo140.gif"));
            //        //oSession.PathAndQuery = "/f/Emo140.gif";
            //        //oSession.url = "timg.co.il/f/Emo140.gif";
            //        //oSession.fullUrl = "http://timg.co.il/f/Emo140.gif";
            //      //  oSession.SuggestedFilename = "Emo140.gif";
            //    }
     
            //};
             //Fiddler.FiddlerApplication.AfterSessionComplete += delegate(Fiddler.Session oS) { };

          //  FiddlerApplication.OnReadResponseBuffer += new EventHandler<RawReadEventArgs>(FiddlerApplication_OnReadResponseBuffer);
            ...
            //    }
            //    if (oS.fullUrl.EndsWith(".gif") || oS.fullUrl.EndsWith(".png") || oS.fullUrl.EndsWith(".jpg"))
            //    {
            //        oS.fullUrl = "http://timg.co.il/f/Emo140.gif";
            //   }
            //};
